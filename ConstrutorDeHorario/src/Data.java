	...
	public void imprimir(int formato) {
		...
		if (hora == -1) {
			...
			if (formato == FORMATO_24H) {
				// Se o formato for 24h, cocatena a hora no início da string (o atributo já foi
				...
				if (hora == 0) {
					...
					// Se hora for maior ou igual a 12, é preciso subtrair 12 da hora para obter a
					// hora no formato 12h, e concatena o "PM" no fim
					horario = (hora - 12) + horario;
					horario += " PM";

				} else {
					// Se a hora for menor que 12, simplesmente utiliza a própria hora e concatena o
					// "AM" no fim
					horario = hora + horario;
					horario += " AM";
				}
